...
export async function GET(request: Request) {
  try {
    ...
    // Check if current month is March (getMonth() === 2 in 0-indexed JS Date: 0=Jan, 1=Feb, 2=Mar)
    ...
    if (isMemoryMode) {
      ...
      // Find previous course if promoted
